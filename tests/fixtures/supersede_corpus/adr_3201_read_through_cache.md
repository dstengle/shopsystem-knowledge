...
status: accepted
description: The projection index is served through a read-through cache answered from memory on a repeated lookup.
---

# ADR-3201: Serve the projection index through a read-through cache
