Feature: Single-source projection extensions
  The knowledge context emits every projection tier and both index entries from
  one source decision document, and gates L1 extraction on a recognized
  decision heading so a non-conforming document is reported rather than
  projected into a silently empty extract.

  @scenario_hash:a6b4bc6d9efd5377 @bc:shopsystem-knowledge
  ...
  @scenario_hash:b04360552695af7c @bc:shopsystem-knowledge
